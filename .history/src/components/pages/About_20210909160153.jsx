  ...
  return (
    <div className="container-fluid">
      ...
      <Row>
        ...
        <Col>
          <Card>
            <h2>Welcome to "PassMe Learn"</h2>
            <p className="content-about">
              Sri Lanka’s latest educational network is called “PassMe.lk”. We
              are giving a chance to get ready for the O/l examination with the
              help of guessing questions and educational and motivational video
              lessons so on. What’s remarkable is that we have an o/l
